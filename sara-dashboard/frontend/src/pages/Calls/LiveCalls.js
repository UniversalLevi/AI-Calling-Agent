                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div>
                      ...
                      <p className="text-base font-medium text-gray-900">{call.caller}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Receiver</p>
                      <p className="text-base font-medium text-gray-900">{call.receiver}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Duration</p>
                      <p className="text-base font-medium text-gray-900">{formatDuration(call.startTime)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Language</p>
                      <p className="text-base font-medium text-gray-900 capitalize">{call.language}</p>
                    </div>
                  </div>
