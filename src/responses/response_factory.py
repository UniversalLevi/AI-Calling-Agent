...
class ResponseFactory:
    ...
    def generate_response(self, user_text: str, call_sid: str = None, 
                         context: str = "booking", phone_number: str = None) -> str:
        """
        ...
        if is_humanized_mode_enabled():
            return handler.generate_response(user_text, call_sid, context, phone_number)
        else:
...
def generate_response(user_text: str, call_sid: str = None, 
    ...
    return factory.generate_response(user_text, call_sid, context, phone_number)
